export const PERMISSIONS = [
  ...
  {
    action: "apartment-types:read",
    resource: "apartment-types",
    operation: "read",
  },
  {
    action: "apartment-types:create",
    resource: "apartment-types",
    operation: "create",
  },
  {
    action: "apartment-types:update",
    resource: "apartment-types",
    operation: "update",
  },
  {
    action: "apartment-types:delete",
    resource: "apartment-types",
    operation: "delete",
  },
  ...
  {
    action: "non-conformities:read",
    resource: "non-conformities",
    operation: "read",
  },
  {
    action: "non-conformities:create",
    resource: "non-conformities",
    operation: "create",
  },
  {
